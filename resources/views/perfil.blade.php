...
<link
href="{{ asset('css/perfilcss.css') }}" rel="stylesheet">
<link
href="https://vjs.zencdn.net/7.2/video-js.min.css" rel="stylesheet">
...
<div class="container emp-profile" >
            {{-- <form method="post"> --}}
                <div
                class="col-12 col-sm-12 col-md-10 col-lg-10">
                ...
                class="row">
                    ...
                    class="col-md-4">
                        ...
                        class="profile-img">
                            <img
                            src="https://acortar.link/MKyYau" alt=""/>
                            <div
                        ...
                        <!-- The Modal -->
                            ...
                            id="myModal">
                                ...
                                class="modal-content">
                                    ...
                                    class="modal-header">
                                    <h4
                                    class="modal-title">Editar Perfil</h4>
                                    <button
                                    type="button"
                                    class="close"
                                    ...
                                    <form
                                    action="{{route('update.user',\Auth::user())}}"
                                    method="POST" >
                                    ...
                                    <div class="modal-corpo">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <label
                                            for="inputPassword4">Apellidos</label>
                                            <input
                                                type="text"
                                                name="lastname"
                                        ...
                                        <div class="form-row">
                                            ...
                                            class="form-group col-md-6">
                                            <label
                                            for="inputPassword4">Contraseña</label>
                                            <input
                                            type="password"
                                            name="password"
                            ...
                            @foreach ($user->UseContractReceive as $Contract)
                                @if ($Contract->con_status != 3)
                                    @if ($Contract->use_tal_id !== null)
                                        <a
                                        href="{{ route('estadoContratoTal',$Contract->id) }}">
                                    ...
                                    @if ($Contract->use_occ_id !== null)
                                        <a
                                        href="{{ route('estadoContratoOcu',$Contract->id) }}">
                            ...
                            @foreach ($user->UseContractReceive as $Contract)
                                @if ($Contract->con_status == 3)
                                    @if ($Contract->use_tal_id !== null)
                                        <a
                                        href="{{ route('estadoContratoTal',$Contract->id) }}">
                                        {{$Contract->IntermediateTal->ser_tal_name}}
                                    </a>
                                    <br/>
                                    @endif
                                    @if ($Contract->use_occ_id !== null)
                                        <a
                                        href="{{ route('estadoContratoOcu',$Contract->id) }}">
                                        {{$Contract->IntermediateOcc->ser_occ_name}}
                                    </a>
                                    <br/>
                                    @endif
                                @endif
                        ...
                        id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="d-flex justify-content-between form-details-get">
                                    <input
                                    type="hidden"
                                    class="get-user-offer-input"
                                    name="userOffer"
                                    value="{{ $serviceUsers->use_id }}" required>
                                    <input
                                    type="hidden"
                                    class="get-price-offer-input"
                                    name="priceOffer"
                                    value="{{ $serviceUsers->precio }}" required>
                                    <input
                                    type="hidden"
                                    class="get-service-offer-input"
                                    name="serviceOffer"
                                    value="{{ $serviceUsers->id }}" required>
                                    <input
                                    type="hidden"
                                    class="get-type-offer-input"
                                    name="typeOfJob" value="1">
                                    @if($serviceUsers->use_occ_group_payment)
                                    @else
                                        <a
                                        href="{{ route('showProfileServiceOccupation',$serviceUsers->id) }}">
                                        {{ $serviceUsers->ser_occ_name }}
                                    </a>
                                    @endif
                                    ...
                                    @if(auth()->user()!=null)
                                        ...
                                        @else
                                            ...
                                            * Para comunicarte
                                            <br> con el que
                                            <br> ofrece el servicio
                                            <br>, presione
                                            <a href="">AQUI</a> </div>

                                            <button
                                            type="button"
                                            class="btn btn-secondary p-3 btn-details-now-data"
                                            disabled>
                                                Contratar
                                            </button>
                                            <br>
                                            @else
                                                ...
                                                @else
                                                    ...
                                                    type="button"
                                                    class="btn btn-secondary p-3 btn-details-now-data"
                                                    onclick="window.location.href='{{ route('showProfileServiceOccupation',$serviceUsers->id) }}'">
                                                        Contratar
                                                    </button>
                                                @endif
                                ...
                                @foreach($user->UseTalIntermediate as $serviceTalUsers)
                                    <div class="d-flex justify-content-between form-details-get">
                                        ...
                                        class="get-price-offer-input"
                                        name="priceOffer"
                                        value="{{ $serviceTalUsers->precio }}"
                                        required>
                                        <input
                                        type="hidden"
                                        class="get-service-offer-input"
                                        name="serviceOffer"
                                        value="{{ $serviceTalUsers->id }}"
                                        required>
                                        <input
                                        type="hidden"
                                        class="get-type-offer-input"
                                        ...
                                        <a
                                        href="{{ route('showProfileServiceTalent',$serviceTalUsers->id) }}">
                                        {{ $serviceTalUsers->ser_tal_name }}
                                    </a>
                                    ...
                                    @if(auth()->user()!=null)
                                        ...
                                        @else
                                            ...
                                            * Para comunicarte
                                            ...
                                            onclick="window.location.href='{{ route('showProfileServiceTalent',$serviceTalUsers->id) }}'">
                                                Contratar
                                            </button>
                            ...
                            id="reto"
                            role="tabpanel"
                            aria-labelledby="reto-tab">
                                @if(count($user->UseOccIntermediate->where('use_occ_group_payment',true))==0 )
                                    <div
                                    class="row pr-4 ml-2 py-3 px-1" >
                                        <div
                                        class="col-4 rounded " >
                                            <img
                                            src="https://acortar.link/DHhDUE"
                                            class="rounded"
                                        ...
                                        class="col-8">
                                            <h2
                                            class="fs-4">
                                            No tienes ningún reto registrado
                                        </h2>
                                            <a
                                            href="{{ route('offerMyServiceChange') }}"
                                            class= "badge badge-light text-dark">
                                            Registre su reto aquí
                                        </a>
                                        </div>
                                    </div>
                                @else
                                    ...
                                    class="row col-sm-12">
                                        ...
                                        class="col-md-6">
                                            <a
                                            href="{{ route('showProfileServiceRetos',$retoActivo->id) }}"
                                            class="badge badge-light text-dark">
                                            <p>{{ $retoActivo->IntermediateChange->cha_name }} <svg
                                    ...
                                    class="row col-sm-12">
                                        ...
                                        class="col-md-6">
                                            <p
                                            class="small">$ {{ $retoActivo->precio }}</p>
                                        </div>
                                    </div>
                                    ...
                                    @else
                                        ...
                                        class="col-sm-12 progress">
                                            ...
                                            class="progress-bar progress-bar-striped progress-bar-animated"
                                            role="progressbar"
                                            style="width: {{ $porcentaje }}%;min-width:5%"
                                            aria-valuenow="{{ $porcentaje }}"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                                    ...
                                    class="row col-sm-12">
                                        ...
                                        class="col-sm-12 contenedor">
                                            @if($retoActivo->IntermediateChange->cha_video !=null)
                                                ...
                                                <br>
                                                <a
                                                href="{{ $serviceUsers->IntermediateChange->cha_video }}">
                                                Link del video
                                            </a>
                                            @else
                                                <h4>
                                                    Aun no se subio ningun video
                                                </h4>
                                                @if(auth()->user()->id == $user->id)
                                                    <label
                                                    for=""
                                                    class="text-info">
                                                    Se habilitara subir video cuando llegue
                                                    por lo menos al 25% de las donaciones.
                                                        Se habilitara en el perfil del reto, de click
                                                        <a
                                                        href="{{ route('showProfileServiceRetos',$retoActivo->id) }}" >
                                                        AQUI</a>
                                                    </label>
                            ...
                            aria-labelledby="historia-tab">
                                ...
                                class="row">
                                      ...
                                      role="tablist">
                                        ...
                                        @foreach($user->UseOccIntermediate->where('use_occ_group_payment',true) as $serviceUsers)
                                            @if($serviceUsers->IntermediateChange->cha_active)
                                                ...
                                                id="list-home-list"
                                                data-toggle="list"
                                                href="{{ '#list-change-'.$serviceUsers->id}}"
                                                role="tab"
                                                aria-controls="home">
                                                {{ $serviceUsers->IntermediateChange->cha_name }}
                                            </a>
                                            @else
                                                <a
                                    ...
                                    class="col-8">
                                      <div
                                      class="tab-content rounded rounded-lg "
                                      id="nav-tabContent">
                                        ...
                                        id="{{ 'list-change-'.$serviceUsers->id}}"
                                        role="tabpanel"
                                        aria-labelledby="list-home-list">
                                            ...
                                            class="row col-sm-12">
                                                ...
                                                class="col-md-6">
                                                    <a
                                                    href="{{ route('showProfileServiceRetos',$serviceUsers->id) }}"
                                                    class="badge badge-light text-dark">
                                                    <p>Ir al perfil del reto
                                            ...
                                            class="container col-md-6">
                                                <img
                                                src="{{ $serviceUsers->imagen }}"
                                                class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}"
                                                alt="No existe miniatura">
                                            </div>
                                        ...
                                        <div
                                        class="tab-pane fade bg-white rounded"
                                        id="{{ 'list-change-'.$serviceUsers->id}}"
                                        role="tabpanel"
                                        aria-labelledby="list-profile-list">
                                            ...
                                            class="row col-sm-12">
                                                ...
                                                class="col-md-12">
                                                    <p
                                                    class="small">{{ $serviceUsers->descripcion }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($Contract->con_status == 1)
                                            @if ($Contract->use_tal_id !== null)
                                                <form action=" {{route('eject.contract')}} " method="POST">
                                                    ...
                                                    type="hidden"
                                                    name="contractId"
                                                    value="{{ $Contract->id }}" required>
                                                    <button
                                                    type="submit"
                                                    class="btn btn-secondary p-3">Ejecutar Servicio</button>
                                                </form>
